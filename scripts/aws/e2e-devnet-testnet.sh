...
cmds = [
    ...
    (
        ...
        "kv=\"$(uname -r)\"; "
        "ko=\"/opt/nitro-cli/lib/modules/$kv/extra/nitro_enclaves/nitro_enclaves.ko\"; "
        "if [ -f \"$ko\" ]; then "
        "sudo mkdir -p \"/lib/modules/$kv/extra/nitro_enclaves\"; "
        "sudo cp -f \"$ko\" \"/lib/modules/$kv/extra/nitro_enclaves/nitro_enclaves.ko\"; "
